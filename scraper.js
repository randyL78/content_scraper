...
// scrape an individual shirt page
const scrapeShirt = (page, index, pages) => {
...
.then(data => {
    ...
    // Scrape individual shirt url
    data.data.pages.forEach(scrapeShirt);  
})
.then( () => {
